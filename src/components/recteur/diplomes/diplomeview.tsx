...
export default function DiplomeView () {
  const getAllDiplomasQuery = api.recteur.diplomas.GetDiplomas.useQuery(1)
  //match the diplomes id with the student id

  const validateDiplomaMutation = api.recteur.diplomas.validateDiploma.useMutation()
  const refuseDiplomaMutation = api.recteur.diplomas.refuseDiploma.useMutation()
