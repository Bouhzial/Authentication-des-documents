...
export default function Dropdown ({ options, optionsValues, onChange, value, className }: Props) {
    ...
    return (
        <div className={`h-16 text-red text-lg font-medium relative ${className || 'w-2/3'} rounded-2xl border border-gray-50`} onFocus={() => { setClicked(true) }} onBlur={() => { setClicked(false) }}>
